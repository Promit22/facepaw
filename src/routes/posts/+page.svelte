...
<div class=" ml-56 grid place-items-center">
		...
		<article class="relative top-5 z-0 m-2 mx-auto my-5 max-w-2xl">
			<Card.Root>
				...
				<Card.Content>
					...
					<section>
						<div class="  rounded-xs p-3 lg:h-[500px] lg:w-[500px]">
							<img src={imagePath} alt="" class="mx-auto my-0 h-full w-full object-contain" />
						</div>
					</section>
					<section>
						<div class="mt-4">
